...
class product_goods_model extends model {
	public function __construct() {
		$this->db_config = pc_base::load_config('database');
		$this->db_setting = 'default';
		$this->table_name = 'product_goods';
		parent::__construct();
	}

	public function get_one_by_barcode($barcode= '') {
		if (empty($barcode)) {
			return false;
		}
		return $this->get_one(array('bar_code'=>$barcode));
	}
